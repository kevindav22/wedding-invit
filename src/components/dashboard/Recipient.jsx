...
const RecipientForm = ({ penerima, setPenerima }) => {
  ...
  return (
    <div className="space-y-3 mb-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-gray-700 text-sm font-medium mb-1">
      ...
      {penerima.map((p, i) => (
        <div key={i} className="grid grid-cols-1 md:grid-cols-2 gap-4 items-center">
          ...
          <input
            ...
            className="border border-gray-300 rounded-lg p-3 text-gray-700 focus:ring-1 focus:ring-amber-400 outline-none"
          />
          ...
          <div className="flex gap-2">
            <input
              ...
              className="border border-gray-300 rounded-lg p-3 text-gray-700 focus:ring-1 focus:ring-amber-400 outline-none w-full"
            />
            {penerima.length > 1 && (
              <button
                onClick={() => handleRemovePenerima(i)}
                className="text-red-500 hover:text-red-600 px-3 text-lg self-center"
                type="button"
              >
                <FaTrash />
              </button>
      ...
      <button
        ...
        className="mt-2 text-amber-600 hover:text-amber-700 flex items-center gap-1 text-sm font-semibold"
        type="button"
      >
